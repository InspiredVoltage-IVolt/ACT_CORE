...
namespace ACT.Core.BuiltInPlugins.DataAccess
{
    ...
    public partial class ACT_MSSQL : ACT_Core, I_DataAccess
    {
        ...
        public void CreateTableFromI_CoreObject(object Class, out string SQL, bool AutoExecute = false, bool CreateIdentity = true, bool Recursive = false)
        {
            throw new NotImplementedException();
        }
        ...
        I_Result I_Plugin.ValidatePluginRequirements()
        {
            throw new NotImplementedException();
        }
    }
