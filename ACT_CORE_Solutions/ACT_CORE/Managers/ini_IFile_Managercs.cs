...
namespace ACT.Core.Managers
{
    public class ini_File_Manager
    {
        ...
        /// </summary>
        public static string OriginalAuthorCredit()
        {
            string authorCredit = "Downloeded On 4-2-2022\n\n";
            authorCredit += "<package xmlns=\"http://schemas.microsoft.com/packaging/2012/06/nuspec.xsd\">\n<metadata>\n\t<id>ini</id>\n\t<version>1.0.7</version>";
            authorCredit += "\n\t<title>A single cs class to read and write INI files.</title>\n\t<authors>grumly57</authors>\n\t<owners>grumly57</owners>\n\t<requireLicenseAcceptance>false</requireLicenseAcceptance>";
            authorCredit += "\n\t<projectUrl>https://gist.github.com/Larry57/5725301</projectUrl>\n\t<description>This INI file handler is a single class that add instant INI reading and writing to your projects.</description>";
            authorCredit += "\n\t<releaseNotes>No longer strip comments \";\" on Save()</releaseNotes>\n\t<tags>ini, ini file, configuration</tags>\n\t<dependencies>\n\t  <group targetFramework=\".NETFramework3.5\" />";
